        ...
        this.polar.series = [
          {
            ...
            id: this.$utils.checkParameter(this.options.id, null),
            label: {
              show: this.options.showLabel,
            ...
            itemStyle: this.options.isGradient
              ? {
                  normal: {
                    color(params) {
                      let index = that.options.color
                        ? params.dataIndex % that.options.color.length
                        : params.dataIndex % that.baseColors.length
                      return new echarts.graphic.LinearGradient(1, 0, 0, 0, [
                        {
                          offset: 0,
                          color: that.options.color
                            ? that.options.color[index][0]
                            : that.baseColors[index][0]
                        },
                        {
                          offset: 1,
                          color: that.options.color
                            ? that.options.color[index][1]
                            : that.baseColors[index][1]
                        }
                      ])
                    },
                    barBorderRadius: 40
                      ...
                      return new echarts.graphic.LinearGradient(1, 0, 0, 0, [
                        {
                          offset: 0,
                          color: that.options.color
                            ? that.options.color[index]
                            : that.baseColor[index]
                        },
                        {
                          offset: 1,
                          color: that.options.color
