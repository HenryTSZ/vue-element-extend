    ...
    <el-tree :data="privilegeList" default-expand-all :expand-on-click-node="false">
      <div class="custom-tree-node" slot-scope="{ node, data }">
        ...
        <span class="tree-permissions">
          <el-checkbox
            v-model="data.hasPreviewPrivilege"
            :indeterminate="data.indeterminatePreview"
            @change="previewChange(data)"
            >预览</el-checkbox
          >
          <el-checkbox
            v-model="data.hasDownloadPrivilege"
            :indeterminate="data.indeterminateDownload"
            @change="permissionsChange(data, 'Download')"
            :disabled="!data.hasPreviewPrivilege"
            >下载</el-checkbox
          >
          <el-checkbox
            v-model="data.hasAddPrivilege"
          ...
          >
          <el-checkbox
            v-model="data.hasUpdatePrivilege"
          ...
          >
          <el-checkbox
            v-model="data.hasDeletePrivilege"
